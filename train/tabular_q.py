...
from smac.facade.smac_rl_facade import SMAC4RL
...
if __name__ == "__main__":
    ...
    parser.add_argument('--obs_space', nargs='+',
                        help='Observation space',
                        required=True,
                        type=str)
    parser.add_argument('--act_space',
                        choices=["binary_random_prob", "random_prob", "exploration_weight"],
                        help='Action space',
                        required=True,
                        type=str)
    parser.add_argument('--reward_fun',
    ...
    parser.add_argument('--horizon',
                        ...
                        required=False,
                        type=int)
    parser.add_argument('-r','--action_repeat',
                        help='How many times to repeat the action',
                        default=1,
                        required=False,
                        type=int)
    parser.add_argument('--acquisition_function',
                        choices=[
                            "AbstractAcquisitionFunction", "EI", "LCB", "LogEI",
                            "AdaptiveLCB", "IntegratedAcquisitionFunction",
                        ],
    ...
    parser.add_argument('-s','--seed',
                        ...
                        default=np.random.randint(0, 2 ** 20),
                        required=False,
                        type=int)
    ...
    parser.add_argument('--learning_starts',
                        help='Number of episodes to roll out with epsilon 1.0',
                        default=0,
                        required=False,
                        type=int)
    parser.add_argument('--eps_decay_starts',
                        help='Whe to start decaying',
                        default=0,
                        required=False,
                        type=int)
